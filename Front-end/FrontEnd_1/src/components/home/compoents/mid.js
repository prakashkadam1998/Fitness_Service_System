  ...
  return (
    ...
    <div class="div2" id="div2">
      ...
      <div class="container-slider">
        <div
           class="panel active back1" >   {/*background img url in style.css*/}
          <div id="slider-div-content">
            <div class="fitway-page-slider h3inslider"><h3>Basic Fitness</h3></div>
            <div class="fitway-page-slider-text">Challenges are what make life interesting. Overcoming them with a fit mind and body. </div>
          </div>
        </div>
