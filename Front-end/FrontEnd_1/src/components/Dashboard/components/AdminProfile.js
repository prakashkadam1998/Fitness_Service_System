...
const AdminProfile = () => {
   ...
   {updateinfobox ?
                  ...
                  :                 <div className='row'>
                        ...
                        <div className="card-footer text-muted">
                            {updateinfobox ?<div><button className='btn btn-success' onClick={Edit}>Submit</button> 
                            <button className='btn btn-danger  ' onClick={updateInfo1}>cancel</button> </div>
                                : <button className='btn btn-success' onClick={updateInfo}>Update Info</button>
                            }
