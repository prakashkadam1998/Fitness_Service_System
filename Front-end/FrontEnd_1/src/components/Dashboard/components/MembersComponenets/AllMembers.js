...
const AllMeembers = () => {
  ...
  const Updaterolemember = (updateMemberID) => {
    ...
    if (window.confirm(`Are you Sure to Update User role with Userid ${updateMemberID} ?`)) {
  ...
  return (
    <div >
      ...
      <div className="counter">Total Members : {allmembersList.length} </div>
      <hr />
      <div>
          ...
          return (
            ...
            <div className="col" >
              <div className="row">
                ...
                <div className="row ">
                  <div className="col">
                    <div>  <strong>User Id :</strong><label>{member.id}   </label>  </div>
                    <div >  <strong>User Name : </strong><label>{member.completeName}</label> </div>
